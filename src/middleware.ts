...
const appPrefixes = ["/feed", "/watch", "/create", "/explore", "/events", "/checkout", "/tickets", "/friends", "/chat", "/notifications", "/u", "/profile/edit", "/settings", "/onboarding", "/verify", "/local-services", "/services", "/benefits", "/creator", "/digital-ai"] as const;
