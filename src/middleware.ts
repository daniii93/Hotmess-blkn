...
const appPrefixes = ["/discover", "/connect", "/feed", "/watch", "/create", "/explore", "/events", "/checkout", "/tickets", "/wallet", "/communities", "/friends", "/chat", "/notifications", "/u", "/profile/edit", "/settings", "/onboarding", "/verify", "/local-services", "/services", "/benefits", "/membership", "/creator", "/digital-ai"] as const;
