...
function hotmess_email_templates(): array
{
    return [
        ...
        'referral_registered'       => ['subject' => 'Deine Einladung wurde angenommen', 'headline' => 'Einladung angenommen.', 'intro' => 'Ein neues Mitglied hat sich über deinen Referral-Code registriert. Du hast dafür Passport Punkte erhalten.', 'ctaLabel' => 'Meine Einladungen', 'ctaUrl' => '/account/referrals'],
        'referral_converted'        => ['subject' => 'Du hast HOTMESS Punkte erhalten', 'headline' => 'Punkte erhalten.', 'intro' => 'Dein geworbenes Mitglied hat eine Aktion abgeschlossen. Deine Referral Punkte wurden deinem Passport Wallet gutgeschrieben.', 'ctaLabel' => 'Passport Wallet', 'ctaUrl' => '/loyalty/wallet'],
        'ambassador_conversion'     => ['subject' => 'Neue Ambassador Conversion', 'headline' => 'Ambassador Conversion.', 'intro' => 'Als Ambassador hast du eine neue Conversion erzielt. Deine Punkte wurden automatisch gutgeschrieben.', 'ctaLabel' => 'Meine Einladungen', 'ctaUrl' => '/account/referrals'],
        'referral_reward_pending'   => ['subject' => 'Deine Empfehlung wird geprüft', 'headline' => 'Empfehlung in Prüfung.', 'intro' => 'Deine Referral-Empfehlung wird aktuell vom HOTMESS Team geprüft. Du wirst benachrichtigt, sobald die Punkte freigegeben werden.', 'ctaLabel' => 'Meine Einladungen', 'ctaUrl' => '/account/referrals'],
        'referral_code_paused'      => ['subject' => 'Dein Referral-Code wurde pausiert', 'headline' => 'Code pausiert.', 'intro' => 'Dein persönlicher Referral-Code wurde vorübergehend pausiert. Neue Einladungen über diesen Code werden aktuell nicht gewertet. Bitte wende dich an das HOTMESS Team.', 'ctaLabel' => 'Kontakt aufnehmen', 'ctaUrl' => '/contact'],
    ];
}
